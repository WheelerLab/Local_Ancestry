...
for (i in c(1:nindv)){
  ...
  # if(nanc==3){
  #   storage_indices<-c(j-2,j-1,j)
  #   corr1<-cor.test(mos_ancestry_decomposed_diploid[,j-2],true_ancestry_decomposed_diploid[,j-1], method="pearson")
  #   corr2<-cor.test(mos_ancestry_decomposed_diploid[,j-1],true_ancestry_decomposed_diploid[,j-2], method="pearson")
  #   corr3<-cor.test(mos_ancestry_decomposed_diploid[,j],true_ancestry_decomposed_diploid[,j], method="pearson")
  #   # if (corr1$estimate < 0){
